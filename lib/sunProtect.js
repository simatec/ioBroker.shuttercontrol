                            ...
                            switch (shutterSettings[s].type) {
                                ...
                                case 'in- & outside temperature': // in- & outside temperature
                                    ...
                                    if ((currentValue === mustValue ||
                                                    ...
                                                    if (pendingAlarm == false) {
                                                        ...
                                                        if (_shutterState?.val) {
                                                            ...
                                                            if (((Math.round(parseFloat(_shutterState.val) / vRound) * vRound > parseFloat(heightDownSun) && convertShutter == false) ||
                                                                (Math.round(parseFloat(_shutterState.val) / vRound) * vRound < parseFloat(heightDownSun) && convertShutter == true)) &&
                                                                ...
                                                                (shutterSettings[s].currentHeight == shutterSettings[s].heightUp ||
                                                                    (shutterSettings[s].heatProtection == true && shutterSettings[s].tempHeatProtection < outsideTemp))) {
                                        ...
                                        if (currentValue === mustValue ||
                                            currentValue === mustValueTilted ||
                                            (currentValue != mustValue && currentValue != mustValueTilted && shutterSettings[s].autoDrive != 'onlyDown') ||
                                            (shutterSettings[s].triggerID == '')) {
                                    ...
                                    if ((currentValue === mustValue ||
                                        ...
                                        if (currentValue === mustValue ||
                                            ...
                                            if (shutterSettings[s].sunProtectEndtimerid === '' &&
                                                ...
                                                adapter.log.debug(`#3 Started sunprotect end delay for ${shutterSettings[s].shutterName} with ${shutterSettings[s].sunProtectEndDely} minutes`);
                                                shutterSettings[s].sunProtectEndtimerid = setTimeout(async function () {
                                        ...
                                        if (currentValue != mustValue &&
                                            ...
                                            if (shutterSettings[s].sunProtectEndtimerid === '' &&
                                                ...
                                                adapter.log.debug(`#4 Started sunprotect end delay for ${shutterSettings[s].shutterName} with ${shutterSettings[s].sunProtectEndDely} minutes`);
                                                shutterSettings[s].sunProtectEndtimerid = setTimeout(async function () {
                                    ...
                                    if (currentValue === mustValue ||
                                        ...
                                        if (currentValue === mustValue ||
                                            ...
                                            if (shutterSettings[s].sunProtectEndtimerid === '' &&
                                                ...
                                                adapter.log.debug(`#5 Started sunprotect end delay for ${shutterSettings[s].shutterName} with ${shutterSettings[s].sunProtectEndDely} minutes`);
                                        ...
                                        if (currentValue != mustValue &&
                                            ...
                                            if (shutterSettings[s].sunProtectEndtimerid === '' &&
                                                ...
                                                adapter.log.debug(`#6 Started sunprotect end delay for ${shutterSettings[s].shutterName} with ${shutterSettings[s].sunProtectEndDely} minutes`);
                                                shutterSettings[s].sunProtectEndtimerid = setTimeout(async function () {
                                ...
                                case 'only direction': //only direction
                                    ...
                                    if (currentValue === mustValue ||
                                        ...
                                        if (currentValue === mustValue ||
                                            currentValue === mustValueTilted || (currentValue != mustValue &&
                                                currentValue != mustValueTilted &&
                                                shutterSettings[s].autoDrive != 'onlyUp') ||
                                            (shutterSettings[s].triggerID == '')) {
                                    ...
                                    if (currentValue === mustValue ||
                                        ...
                                        if (currentValue === mustValue ||
                                            ...
                                            if (shutterSettings[s].sunProtectEndtimerid === '' &&
                                                ...
                                                adapter.log.debug(`#7 Started sunprotect end delay for ${shutterSettings[s].shutterName} with ${shutterSettings[s].sunProtectEndDely} minutes`);
                                                shutterSettings[s].sunProtectEndtimerid = setTimeout(async function () {
                                                    adapter.log.debug(`#7.1 End sunprotect delay for ${shutterSettings[s].shutterName}`);
                                                    shutterSettings[s].sunProtectEndtimerid = '0';
                                                }, shutterSettings[s].sunProtectEndDely * 60000, s);
                                            }
                                            if ((shutterSettings[s].lightSensor != '' &&
                                                parseFloat(hysteresisLight) > sunLight &&
                                                shutterSettings[s].sunProtectEndtimerid === '0') ||
                                                (parseFloat(hysteresisOutside) > outsideTemp)) {
                                        ...
                                        if (currentValue != mustValue &&
                                            ...
                                            if (shutterSettings[s].sunProtectEndtimerid === '' &&
                                                ...
                                                adapter.log.debug(`#8 Started sunprotect end delay for ${shutterSettings[s].shutterName} with ${shutterSettings[s].sunProtectEndDely} minutes`);
        ...
        for (const i in result) {
            for (const s in shutterSettings) {
                if (shutterSettings[s].shutterName == result[i].shutterName) {
                    ...
                    if (elevation <= sunProtEndStart &&
                        elevation >= sunProtEndStop &&
                        (shutterSettings[s].currentAction == 'sunProtect' ||
