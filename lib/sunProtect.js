    ...
    setTimeout(function () {
        ...
        */
        ...
        if (resultFull) {
            ...
            for (const i in result) {
                if (elevation <= sunProtEndStart && elevation >= sunProtEndStop && result[i].KeepSunProtect == false && (result[i].currentAction == 'sunProtect' || result[i].currentAction == 'manu_sunProtect')) {
                    let nameDevice = result[i].shutterName.replace(/[.;, ]/g, '_');
                            ...
                            setTimeout(function () {
                                ...
                                adapter.getForeignState(result[i].triggerID, (err, state) => {
                                    ...
                                    if (currentValue === mustValue && result[i].tempSensor != '' || (currentValue != mustValue && result[i].autoDrive != 'onlyDown' && result[i].autoDrive != 'off') || (result[i].triggerID == '')) {
                                        ...
                                        adapter.getForeignState(result[i].name, (err, state) => {
                                            if (typeof state != undefined && state != null) {
                                                if ((result[i].currentAction == 'sunProtect' || result[i].currentAction == 'manu_sunProtect') && (parseFloat(state.val) == parseFloat(result[i].heightDownSun) || parseFloat(state.val) == parseFloat(result[i].currentHeight))) {
                                                    result[i].currentAction = 'none';
                                                    adapter.setState('shutters.autoState.' + nameDevice, { val: result[i].currentAction, ack: true });
