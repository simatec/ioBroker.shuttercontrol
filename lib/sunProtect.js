                                                                    ...
                                                                    adapter.getForeignState(shutterSettings[s].lightSensor, (err, state) => {
                                                                                    ...
                                                                                    if (pendingAlarm == false) {
                                                                                        ...
                                                                                        adapter.getForeignState(shutterSettings[s].name, (err, state) => {
                                                                                            if (typeof state != undefined && state != null) {
                                                                                                ...
                                                                                                if (((parseFloat(state.val) > parseFloat(shutterSettings[s].heightDownSun) && convertShutter == false) || (parseFloat(state.val) < parseFloat(shutterSettings[s].heightDownSun) && convertShutter == true)) && parseFloat(state.val) == parseFloat(shutterSettings[s].currentHeight) && shutterSettings[s].currentHeight == shutterSettings[s].heightUp && shutterSettings[s].triggerAction != 'down' && shutterSettings[s].currentAction != 'middle' && shutterSettings[s].currentAction != 'Xmas') {
                                                                        ...
                                                                        if (currentValue === mustValue || currentValue === mustValueTilted || (currentValue != mustValue && currentValue != mustValueTilted && shutterSettings[s].autoDrive != 'onlyDown') || (shutterSettings[s].triggerID == '')) {
                                                                            ...
                                                                            if (shutterSettings[s].sunProtectEndtimerid === '' && shutterSettings[s].lightSensor != '' && parseFloat(hysteresisLight) > sunLight && shutterSettings[s].currentAction == 'sunProtect' && shutterSettings[s].KeepSunProtect === false) {
                                                                                ...
                                                                                shutterSettings[s].sunProtectEndtimerid = setTimeout(function () {
