                                ...
                                adapter.getForeignState(shutterSettings[s].triggerID, (err, state) => {
                                    ...
                                    if (currentValue != mustValue) {
                                        ...
                                        adapter.getForeignState(shutterSettings[s].name, (err, state) => {
                                            ...
                                            if (typeof state != undefined && state != null && parseFloat(state.val) != setTriggerHeight && shutterSettings[s].triggerChange != 'off' && ((parseFloat(shutterSettings[s].triggerDriveTildet) == setTriggerHeight && parseFloat(state.val) != setTriggerHeight) || (parseFloat(state.val) < setTriggerHeight && convertShutter == false) || (parseFloat(state.val) > setTriggerHeight && convertShutter == true))) {
