                        ...
                        if (_autoUpState && _autoUpState === true || _autoUpState && _autoUpState.val === true) {
                            ...
                            if (currentValue != mustValue) {
                                ...
                                if (_shutterState && _shutterState.val) {
                                    adapter.log.debug(shutterSettings[s].shutterName + ' - shutter current state.val is:' + _shutterState.val);
                                }
                                ...
                                if (typeof _shutterState != undefined && _shutterState != null && parseFloat(_shutterState.val) != setTriggerHeight && shutterSettings[s].triggerChange != 'off' && ((parseFloat(shutterSettings[s].triggerDriveTildet) == setTriggerHeight && parseFloat(_shutterState.val) != setTriggerHeight && shutterSettings[s].currentAction == 'triggered') || (parseFloat(_shutterState.val) < setTriggerHeight && convertShutter == false) || (parseFloat(_shutterState.val) > setTriggerHeight && convertShutter == true))) {
                                    shutterSettings[s].triggerHeight = shutterSettings[s].currentAction != 'triggered' ? parseFloat(_shutterState.val) : shutterSettings[s].triggerHeight;
                                    ...
                                    if (currentValue != mustValue) {
                                        ...
                                        try {
                                            ...
                                            adapter.log.warn(`#triggerChange 3: ${err}`);
                                        }

                                        adapter.log.debug(shutterSettings[s].shutterName + ' - window is still open -> driving now to :' + setTriggerHeight);
                                    }
                                    await sleep(shutterSettings[s].trigDelyUp ? shutterSettings[s].trigDelyUp * 1000 : 100);
                        ...
                        if (_autoDownState && _autoDownState === true || _autoDownState && _autoDownState.val === true) {
                            ...
                            if (typeof _triggerState != undefined && _triggerState != null) {
                                ...
                                if (currentValue === mustValue) {
                                    ...
                                    if (typeof _shutterState != undefined && _shutterState != null && shutterSettings[s].triggerHeight != null && shutterSettings[s].triggerAction != null && parseFloat(_shutterState.val) != shutterSettings[s].triggerHeight && parseFloat(_shutterState.val) == parseFloat(shutterSettings[s].currentHeight) && shutterSettings[s].triggerChange != 'off') {
                                        ...
                                        if (typeof _triggerState != undefined && _triggerState != null) {
                                            ...
                                            if (currentValue === mustValue) {
                                                ...
                                                try {
                                                    ...
                                                    adapter.log.warn(`#triggerChange 2: ${err}`);
                                                }

                                                adapter.log.debug('save back trigger action: ' + shutterSettings[s].triggerAction + ' for device: ' + shutterSettings[s].shutterName);
                                            }
                                        }
                                        await sleep(shutterSettings[s].trigDelyDown ? shutterSettings[s].trigDelyDown * 1000 : 100);

                                    } else if (typeof _shutterState != undefined && _shutterState != null && shutterSettings[s].triggerHeight != null && parseFloat(_shutterState.val) == shutterSettings[s].triggerHeight && shutterSettings[s].triggerChange != 'off') {
                                        if (shutterSettings[s].triggerAction == '') {
                                            adapter.log.debug('Warning! - not allowed empty values detected - close your window and initialize your shutters with button up! - triggerAction: ' + shutterSettings[s].triggerAction + ' at device: ' + shutterSettings[s].shutterName);
                                        }
                                        shutterSettings[s].currentHeight = shutterSettings[s].triggerHeight;
                        ...
                        if (_autoDownState && _autoDownState === true || _autoDownState && _autoDownState.val === true) {
                            ...
                            if (typeof _triggerState != undefined && _triggerState != null) {
                                ...
                                if (currentValue === mustValue || currentValue === mustValueTilted) {
                                    ...
                                    if (typeof _shutterState != undefined && _shutterState != null && shutterSettings[s].triggerHeight != null && parseFloat(_shutterState.val) != shutterSettings[s].triggerHeight && parseFloat(_shutterState.val) != shutterSettings[s].heightDown) {
                                        if (shutterSettings[s].triggerAction == '') {
                                            adapter.log.debug('Warning! - not allowed empty values detected - close your window and initialize your shutters with button up! - triggerAction: ' + shutterSettings[s].triggerAction + ' at device: ' + shutterSettings[s].shutterName);
                                        }
                                    ...
                                    } else if (typeof _shutterState != undefined && _shutterState != null && shutterSettings[s].triggerHeight != null && parseFloat(_shutterState.val) == shutterSettings[s].triggerHeight) {
                                        if (shutterSettings[s].triggerAction == '') {
                                            adapter.log.debug('Warning! - not allowed empty values detected - close your window and initialize your shutters with button up! - triggerAction: ' + shutterSettings[s].triggerAction + ' at device: ' + shutterSettings[s].shutterName);
                                        }
                                        shutterSettings[s].currentHeight = shutterSettings[s].triggerHeight;
