                                ...
                                adapter.getForeignState(shutterSettings[s].triggerID, (err, state) => {
                                    ...
                                    if (currentValue != mustValue) {
                                        ...
                                        adapter.getForeignState(shutterSettings[s].name, (err, state) => {
                                            ...
                                            if (typeof state != undefined && state != null && parseFloat(state.val) != setTriggerHeight && shutterSettings[s].triggerChange != 'off' && ((parseFloat(shutterSettings[s].triggerDriveTildet) == setTriggerHeight && parseFloat(state.val) != setTriggerHeight && shutterSettings[s].currentAction == 'triggered') || (parseFloat(state.val) < setTriggerHeight && convertShutter == false) || (parseFloat(state.val) > setTriggerHeight && convertShutter == true))) {
                                    ...
                                    if (typeof state != undefined && state != null) {
                                        ...
                                        if (currentValue === mustValue) {
                                            ...
                                            adapter.getForeignState(shutterSettings[s].name, (err, state) => {
                                                ...
                                                if (typeof state != undefined && state != null && shutterSettings[s].triggerHeight != null && shutterSettings[s].triggerAction != null && parseFloat(state.val) != shutterSettings[s].triggerHeight && parseFloat(state.val) == parseFloat(shutterSettings[s].currentHeight) && shutterSettings[s].triggerChange != 'off') {
