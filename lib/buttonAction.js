            ...
            for (const s in shutterSettings) {
                if (shutterSettings[s].shutterName == result[i].shutterName) {
                    ...
                    if (buttonState == 'closeAll' || buttonState == 'closeLiving' || buttonState == 'closeSleep' || buttonState == 'closeChildren') {
                        ...
                        if (typeof _shutterState != undefined && _shutterState != null && Math.round(_shutterState.val / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != shutterSettings[s].heightUp) {
                        ...
                        else if (typeof _shutterState != undefined && _shutterState != null && Math.round(_shutterState.val / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == shutterSettings[s].heightUp) {
                            shutterSettings[s].currentHeight = shutterSettings[s].heightUp;
                            shutterSettings[s].triggerHeight = shutterSettings[s].heightUp;
                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].currentHeight;
                            shutterSettings[s].currentAction = 'up';
                        ...
                        if (typeof _shutterState != undefined && _shutterState != null && Math.round(_shutterState.val / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != shutterSettings[s].heightDownSun) {
                        ...
                        else if (typeof _shutterState != undefined && _shutterState != null && Math.round(_shutterState.val / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == shutterSettings[s].heightDownSun) {
                            shutterSettings[s].currentHeight = shutterSettings[s].heightDownSun;
                            shutterSettings[s].triggerHeight = shutterSettings[s].heightDownSun;
                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].currentHeight;
                            shutterSettings[s].currentAction = 'manu_sunProtect';
                        ...
                        if (typeof _shutterState != undefined && _shutterState != null && typeof _shutterState.val) {
                            ...
                            if (Math.round(_shutterState.val / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == shutterSettings[s].heightDownSun) {
                            ...
                            } else if (Math.round(_shutterState.val / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == shutterSettings[s].heightUp) {
                                shutterSettings[s].currentHeight = shutterSettings[s].heightUp;
                                shutterSettings[s].triggerHeight = shutterSettings[s].heightUp;
                                shutterSettings[s].alarmTriggerLevel = shutterSettings[s].currentHeight;
                                shutterSettings[s].currentAction = 'up';
                                ...
                                adapter.log.debug(`shutterUpButton ${shutterSettings[s].shutterName} old height: ${shutterSettings[s].oldHeight}% new height: ${shutterSettings[s].heightUp}%`);
                            } else if (Math.round(_shutterState.val / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == shutterSettings[s].heightDown) {
