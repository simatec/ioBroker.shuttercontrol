                    ...
                    switch (alarmType) {
                        ...
                        case 'alarmWind1':
                            if (statusAlarmWind1) {
                                ...
                                if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != parseFloat(alarmWind1Level) && statusAlarmFire == false) {
                                ...
                                else if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == parseFloat(alarmWind1Level) && statusAlarmFire == false) {
                                    if ((statusAlarmWind2 == false && statusAlarmRain == false && statusAlarmFrost == false && statusAlarmFire == false)) {
                                        if (currentValue != '' && currentValue != mustValue && currentValue != mustValueTilted && shutterSettings[s].driveAfterClose == true) {
                                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].triggerHeight;
                                            shutterSettings[s].alarmTriggerAction = shutterSettings[s].triggerAction;
                                ...
                                if (pendingAlarm == false && statusAlarmFrost == false) {
                                    if (currentValue === mustValue || currentValue === mustValueTilted || shutterSettings[s].triggerID == '') {
                                        ...
                                        if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != parseFloat(shutterSettings[s].alarmTriggerLevel)) {
                                        ...
                                        else if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == parseFloat(shutterSettings[s].alarmTriggerLevel)) {
                                            shutterSettings[s].currentHeight = parseFloat(shutterSettings[s].alarmTriggerLevel);
                                            shutterSettings[s].triggerHeight = shutterSettings[s].currentHeight;
                                            shutterSettings[s].currentAction = shutterSettings[s].alarmTriggerAction;
                                            shutterSettings[s].triggerAction = shutterSettings[s].currentAction;
                        ...
                        case 'alarmWind2':
                            if (statusAlarmWind2) {
                                ...
                                if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != parseFloat(alarmWind2Level) && statusAlarmFire == false) {
                                ...
                                else if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == parseFloat(alarmWind2Level)) {
                                ...
                                if (pendingAlarm == false && statusAlarmFrost == false) {
                                    if (currentValue === mustValue || currentValue === mustValueTilted || shutterSettings[s].triggerID == '') {
                                        ...
                                        if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != parseFloat(shutterSettings[s].alarmTriggerLevel) && statusAlarmFire == false) {
                                            shutterSettings[s].currentHeight = parseFloat(shutterSettings[s].alarmTriggerLevel);
                                            shutterSettings[s].triggerHeight = shutterSettings[s].currentHeight;
                                            shutterSettings[s].currentAction = shutterSettings[s].alarmTriggerAction;
                                            shutterSettings[s].triggerAction = shutterSettings[s].currentAction;
                        ...
                        case 'alarmRain':
                            if (statusAlarmRain == true) {
                                ...
                                if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != parseFloat(alarmRainLevel) && statusAlarmFire == false) {
                                ...
                                else if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == parseFloat(alarmRainLevel) && statusAlarmFire == false) {
                                    if (statusAlarmWind1 == false && statusAlarmWind2 == false && statusAlarmFrost == false && statusAlarmFire == false) {
                                        if (currentValue != '' && currentValue != mustValue && currentValue != mustValueTilted && shutterSettings[s].driveAfterClose == true) {
                                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].triggerHeight;
                                            shutterSettings[s].alarmTriggerAction = shutterSettings[s].triggerAction;
                        ...
                        case 'alarmFrost':
                            if (statusAlarmFrost == true) {
                                ...
                                if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != parseFloat(alarmFrostLevel) && statusAlarmFire == false) {
                                    if (currentValue != '' && currentValue != mustValue && currentValue != mustValueTilted && shutterSettings[s].driveAfterClose == true) {
                                    ...
                                    } else if (_shutterState.val == shutterSettings[s].heightDown && (currentValue === mustValue || currentValue === mustValueTilted || currentValue == '')) {
                                        if (statusAlarmWind1 == false && statusAlarmWind2 == false && statusAlarmRain == false && statusAlarmFire == false) {
                                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].currentHeight;
                                            shutterSettings[s].alarmTriggerAction = shutterSettings[s].currentAction;
                                        }
                                        if ((Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound < parseFloat(alarmFrostLevel) && convertShutter == false) || (Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound > parseFloat(alarmFrostLevel) && convertShutter == true)) {
                                ...
                                else if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == parseFloat(alarmFrostLevel) && statusAlarmFire == false) {
                                    if (currentValue != '' && currentValue != mustValue && currentValue != mustValueTilted && shutterSettings[s].driveAfterClose == true) {
                                        if (statusAlarmWind1 == false && statusAlarmWind2 == false && statusAlarmRain == false && statusAlarmFire == false) {
                                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].triggerHeight;
                                            shutterSettings[s].alarmTriggerAction = shutterSettings[s].triggerAction;
                        ...
                        case 'alarmFire':
                            if (statusAlarmFire == true) {
                                ...
                                if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound != parseFloat(alarmFireLevel)) {
                                ...
                                else if (typeof _shutterState != undefined && _shutterState != null && Math.round(parseFloat(_shutterState.val) / adapter.config.shutterStateRound) * adapter.config.shutterStateRound == parseFloat(alarmFireLevel)) {
                                    if (statusAlarmWind1 == false && statusAlarmWind2 == false && statusAlarmRain == false && statusAlarmFrost == false) {
                                        shutterSettings[s].alarmTriggerLevel = shutterSettings[s].currentHeight;
                                        shutterSettings[s].alarmTriggerAction = shutterSettings[s].currentAction;
                                    }
