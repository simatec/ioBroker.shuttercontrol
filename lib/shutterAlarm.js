        ...
        for (const i in result) {
            for (const s in shutterSettings) {
                if (shutterSettings[s].shutterName === result[i].shutterName) {
                    ...
                    if (_alarmWind1 && _alarmWind1.val !== undefined) {
                    ...
                    if (_alarmWind2 && _alarmWind2.val !== undefined) {
                    ...
                    if (_alarmFrost && _alarmFrost.val !== undefined) {
                    ...
                    if (_alarmFire && _alarmFire.val !== undefined) {
                    ...
                    if (_triggerState && _triggerState.val !== undefined) {
                    ...
                    switch (alarmType) {
                        ...
                        case 'alarmWind1':
                            if (statusAlarmWind1 === true) {
                                ...
                                if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) !== parseFloat(alarmWind1Level) && statusAlarmFire === false) {
                                ...
                                else if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) === parseFloat(alarmWind1Level) && statusAlarmFire === false) {
                                    if ((statusAlarmWind2 === false && statusAlarmRain === false && statusAlarmFrost === false && statusAlarmFire === false)) {
                                        if (currentValue !== '' && currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].driveAfterClose === true) {
                                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].triggerHeight;
                                            shutterSettings[s].alarmTriggerAction = shutterSettings[s].triggerAction;
                                ...
                                if (pendingAlarm === false && statusAlarmFrost === false) {
                                    if (currentValue === mustValue || currentValue === mustValueTilted || shutterSettings[s].triggerID === '') {
                                        ...
                                        if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) !== parseFloat(shutterSettings[s].alarmTriggerLevel)) {
                                        ...
                                        else if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) === parseFloat(shutterSettings[s].alarmTriggerLevel)) {
                                            shutterSettings[s].currentHeight = parseFloat(shutterSettings[s].alarmTriggerLevel);
                                            shutterSettings[s].triggerHeight = shutterSettings[s].currentHeight;
                                            shutterSettings[s].currentAction = shutterSettings[s].alarmTriggerAction;
                                            shutterSettings[s].triggerAction = shutterSettings[s].currentAction;
                        ...
                        case 'alarmWind2':
                            if (statusAlarmWind2 === true) {
                                ...
                                if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) !== parseFloat(alarmWind2Level) && statusAlarmFire === false) {
                                ...
                                else if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) === parseFloat(alarmWind2Level)) {
                                ...
                                if (pendingAlarm === false && statusAlarmFrost === false) {
                                    if (currentValue === mustValue || currentValue === mustValueTilted || shutterSettings[s].triggerID === '') {
                                        ...
                                        if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) !== parseFloat(shutterSettings[s].alarmTriggerLevel) && statusAlarmFire === false) {
                                            shutterSettings[s].currentHeight = parseFloat(shutterSettings[s].alarmTriggerLevel);
                                            shutterSettings[s].triggerHeight = shutterSettings[s].currentHeight;
                                            shutterSettings[s].currentAction = shutterSettings[s].alarmTriggerAction;
                                            shutterSettings[s].triggerAction = shutterSettings[s].currentAction;
                        ...
                        case 'alarmRain':
                            if (statusAlarmRain === true) {
                                ...
                                if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) !== parseFloat(alarmRainLevel) && statusAlarmFire === false) {
                                ...
                                else if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) === parseFloat(alarmRainLevel) && statusAlarmFire === false) {
                                    if (statusAlarmWind1 === false && statusAlarmWind2 === false && statusAlarmFrost === false && statusAlarmFire === false) {
                                        if (currentValue !== '' && currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].driveAfterClose === true) {
                                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].triggerHeight;
                                            shutterSettings[s].alarmTriggerAction = shutterSettings[s].triggerAction;
                        ...
                        case 'alarmFrost':
                            if (statusAlarmFrost === true) {
                                ...
                                if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) !== parseFloat(alarmFrostLevel) && statusAlarmFire === false) {
                                    if (currentValue !== '' && currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].driveAfterClose === true) {
                                ...
                                else if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) === parseFloat(alarmFrostLevel) && statusAlarmFire === false) {
                                    if (currentValue !== '' && currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].driveAfterClose === true) {
                                        if (statusAlarmWind1 === false && statusAlarmWind2 === false && statusAlarmRain === false && statusAlarmFire === false) {
                                            shutterSettings[s].alarmTriggerLevel = shutterSettings[s].triggerHeight;
                                            shutterSettings[s].alarmTriggerAction = shutterSettings[s].triggerAction;
                        ...
                        case 'alarmFire':
                            if (statusAlarmFire === true) {
                                ...
                                if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) !== parseFloat(alarmFireLevel)) {
                                ...
                                else if (_shutterState && _shutterState.val !== undefined && parseFloat(_shutterState.val) === parseFloat(alarmFireLevel)) {
                                    if (statusAlarmWind1 === false && statusAlarmWind2 === false && statusAlarmRain === false && statusAlarmFrost === false) {
                                        shutterSettings[s].alarmTriggerLevel = shutterSettings[s].currentHeight;
                                        shutterSettings[s].alarmTriggerAction = shutterSettings[s].currentAction;
                                    }
...
async function checkPendingAlarm(adapter, Shutter) {
    return new Promise(async (resolve) => {
        ...
        try {
            ...
            if (_statusAlarmWind1 && _statusAlarmWind1.val !== undefined) {
            ...
            if (_statusAlarmWind2 && _statusAlarmWind2.val !== undefined) {
            ...
            if (_statusAlarmRain && _statusAlarmRain.val !== undefined) {
            ...
            if (_statusAlarmFire && _statusAlarmFire.val !== undefined) {
...
async function checkFrostAlarm(adapter, Shutter) {
    return new Promise(async (resolve) => {
        ...
        try {
            ...
            if (_resAlarmFrost && _resAlarmFrost.val !== undefined ) {
