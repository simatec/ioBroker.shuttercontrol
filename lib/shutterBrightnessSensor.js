                                ...
                                if (shutterSettings[s].currentAction !== 'triggered' || shutterSettings[s].currentAction !== 'triggered_Tilted' || shutterSettings[s].currentAction !== 'down') {
                                    if (pendingAlarm === false) {
                                        ...
                                        if (currentValue === mustValue || currentValue === mustValueTilted || (currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].autoDrive !== 'onlyUp' && shutterSettings[s].autoDrive !== 'off')) {
                                            ...
                                            if (typeof _shutterState !== undefined && _shutterState !== null && _shutterState.val !== targetLevel2Set && shutterSettings[s].triggerAction !== 'down' && (shutterSettings[s].lastAutoAction !== 'Down_Brightness' || (shutterSettings[s].lastAutoAction === 'Down_Brightness' && shutterSettings[s].currentAction === 'Manu_Mode'))) {
                                            ...
                                            if (typeof _shutterState !== undefined && _shutterState !== null && _shutterState.val !== targetLevel2Set && shutterSettings[s].lastAutoAction !== 'Down_Brightness' && (_shutterState.val === shutterSettings[s].heightDownSun || _shutterState.val === shutterSettings[s].heightUp || _shutterState.val === shutterSettings[s].triggerDrive)) {
                                                shutterSettings[s].currentHeight = targetLevel2Set;
                                                shutterSettings[s].currentAction = downAction;
                                                shutterSettings[s].lastAutoAction = 'Down_Brightness';
                            ...
                            if (pendingAlarm === false) {
                                ...
                                if (pendingAlarm === false) {
                                    if (currentValue === mustValue || currentValue === mustValueTilted || (currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].autoDrive !== 'onlyDown' && shutterSettings[s].autoDrive !== 'off')) {
                                        ...
                                        if (typeof _shutterState !== undefined && _shutterState !== null && _shutterState.val !== shutterHeight && shutterSettings[s].lastAutoAction !== 'up_Brightness') {
