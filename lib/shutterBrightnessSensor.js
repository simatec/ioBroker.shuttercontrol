                                ...
                                if (shutterSettings[s].currentAction !== 'triggered' || shutterSettings[s].currentAction !== 'triggered_Tilted' || shutterSettings[s].currentAction !== 'down') {
                                    if (pendingAlarm === false) {
                                        ...
                                        if (currentValue === mustValue || currentValue === mustValueTilted || (currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].autoDrive !== 'onlyUp' && shutterSettings[s].autoDrive !== 'off')) {
                                            ...
                                            if (_shutterState && _shutterState.val !== undefined && _shutterState.val !== targetLevel2Set && shutterSettings[s].triggerAction !== 'down') {
                                            ...
                                            else if (_shutterState && _shutterState.val !== undefined && _shutterState.val === targetLevel2Set && (shutterSettings[s].currentHeight !== targetLevel2Set || shutterSettings[s].currentAction !== downAction)) {
                                                shutterSettings[s].currentHeight = targetLevel2Set;
                                                shutterSettings[s].currentAction = downAction;
                                            ...
                                            if (_shutterState && _shutterState.val !== undefined && _shutterState.val !== targetLevel2Set && shutterSettings[s].lastAutoAction !== 'Down_Brightness' && (_shutterState.val === shutterSettings[s].heightDownSun || _shutterState.val === shutterSettings[s].heightUp || _shutterState.val === shutterSettings[s].triggerDrive)) {
                                                shutterSettings[s].currentHeight = targetLevel2Set;
                                                shutterSettings[s].currentAction = downAction;
                                                shutterSettings[s].lastAutoAction = 'Down_Brightness';
                                            ...
                                            if (_shutterState && _shutterState.val !== undefined && _shutterState.val !== targetLevel2Set && (_shutterState.val === shutterSettings[s].heightDownSun || _shutterState.val === shutterSettings[s].heightUp || _shutterState.val === shutterSettings[s].triggerDrive)) {
                            ...
                            if (pendingAlarm === false) {
                                ...
                                if (pendingAlarm === false) {
                                    if (currentValue === mustValue || currentValue === mustValueTilted || (currentValue !== mustValue && currentValue !== mustValueTilted && shutterSettings[s].autoDrive !== 'onlyDown' && shutterSettings[s].autoDrive !== 'off')) {
                                        ...
                                        if (_shutterState && _shutterState.val !== undefined && _shutterState.val !== shutterHeight && shutterSettings[s].lastAutoAction !== 'up_Brightness') {
                                        ...
                                        else if (_shutterState && _shutterState.val !== undefined && _shutterState.val === shutterHeight) {
                                            shutterSettings[s].currentHeight = shutterHeight;
                                            shutterSettings[s].triggerHeight = shutterSettings[s].currentHeight; // reset Trigger
                                            shutterSettings[s].triggerAction = shutterSettings[s].currentAction; // reset Trigger
                                        ...
                                        if (_shutterState && _shutterState.val !== undefined && _shutterState.val !== shutterHeight) {
