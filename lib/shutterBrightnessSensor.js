...
async function shutterBrightnessSensor(adapter, brightnessValue, shutterSettings, brightnessDown) {
    ...
    if (currentTime > adapter.config.lightsensorDownTime && brightnessValue <= shutterDownBrightness && brightnessDown == false) {
        if (shutterSettings) {
    ...
    } else if (currentTime <= adapter.config.lightsensorUpTime && brightnessValue > shutterUpBrightness) {
        if (shutterSettings) {
